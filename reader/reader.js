...
// #status-text, not #status itself — #status also now holds the theme
// toggle buttons (see index.html); overwriting the whole container's
// textContent on every status update would silently delete those too.
